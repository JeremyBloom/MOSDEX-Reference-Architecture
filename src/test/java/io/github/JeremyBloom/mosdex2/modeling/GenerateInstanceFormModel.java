 ...
 * Generates JSON, Spark, lp and mps output.
 *
 * @author Dr. Jeremy A. Bloom (jeremyblmca@gmail.com) ©2019 Jeremy A. Bloom
 *
 */
public class GenerateInstanceFormModel {
	 ...
	 * 
	 */
	public GenerateInstanceFormModel() {
	...
	public static void main(String[] args) {
		...
		Msdx.GLOBAL.setDisplayTitle("Transshipment MOSDEX Instance-Form Demo: Spark, LP, MPS");
		Msdx.GLOBAL.showDisplay();
		
		Msdx.GLOBAL.out.println("JSON Test");
		json();
		Msdx.GLOBAL.out.println();
		
		Msdx.GLOBAL.out.println("Spark Test");
		spark();
		Msdx.GLOBAL.out.println();
		
		Msdx.GLOBAL.out.println("LP File Test");
		lp();
		Msdx.GLOBAL.out.println();
		
		Msdx.GLOBAL.out.println("MPS File Test");
		mps();
		Msdx.GLOBAL.out.println();
  ...
  "MODULES": [
	...
	public static void spark() {
		...
		for(String tableName: tables.keySet()) {
			Msdx.GLOBAL.out.println("TransshipmentTest4.spark: table: " + tableName);
...
}//class GenerateInstanceFormModel
